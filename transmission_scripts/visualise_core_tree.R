...
write.tree(annot_tree, str_glue("data/trees/clonal_frame/{bug_prefix}.core_gene_alignment_filtered.snps.trimmed.vfasttree.recomb_pruned.labelled_tree.annot.newick"))
