...
amr_df <- fread("results/amr_out/resfinder_out/resfinder.assemblies.c0.8.parsed.csv") %>% 
...
merged %>%
  fwrite("results/amr_out/amr_matrices/resfinder.assemblies.c0.8.gene_content.csv")
